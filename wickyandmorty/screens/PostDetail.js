...
import {  View, Text, Image, Button, StyleSheet, ScrollView, Alert, TextInput } from 'react-native';
    ...
    <ScrollView style={styles.container}>
        <View style={styles.post}>
          <View style={[styles.row, styles.head]}>
            ...
            <Text style={[styles.text,styles.margin,styles.username]}>{username}</Text>
          </View>
            {post.image && (
